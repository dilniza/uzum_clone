...
import (
	...
	os "service/genproto/order_service"
)
...
type OrderyRepoI interface {
	Create(ctx context.Context, req *os.CreateOrder) (resp *os.GetOrder, err error)
	GetByID(ctx context.Context, req *os.OrderPrimaryKey) (resp *os.GetOrder, err error)
	//GetALL(ctx context.Context, req *os.GetListCategoryRequest) (resp *os.GetListCategoryResponse, err error)
	//Update(ctx context.Context, req *os.UpdateOrder) (resp *os.GetOrder, err error)
	//Delete(ctx context.Context, req *os.OrderPrimaryKey) (resp *os.Empty, err error)
}

type OrderProductepoI interface {
	Create(ctx context.Context, req *os.CreateOrderProducts) (resp *os.GetOrderProducts, err error)
	GetByID(ctx context.Context, req *os.OrderProductsPrimaryKey) (resp *os.GetOrderProducts, err error)
	//GetALL(ctx context.Context, req *os.GetListCategoryRequest) (resp *os.GetListCategoryResponse, err error)
	//Update(ctx context.Context, req *os.UpdateOrder) (resp *os.GetOrder, err error)
	//Delete(ctx context.Context, req *os.OrderPrimaryKey) (resp *os.Empty, err error)
}
...
type OrderStatusI interface {
	Create(ctx context.Context, req *os.CreateStatusRequest) (resp *os.GetOrderStatusResponse, err error)
	GetByID(ctx context.Context, req *os.OrderPrimaryKeyRequest) (resp *os.GetOrderStatusResponse, err error)
	PUTCH(ctx context.Context, req *os.OrderPrimaryStatusKeyRequest) (resp *os.GetOrderStatusResponse, err error)
	GetStatusByID(ctx context.Context, req *os.OrderPrimaryStatusKeyRequest) (resp *os.GetOrderStatusResponse, err error)
	// //GetALL(ctx context.Context, req *os.GetListCategoryRequest) (resp *os.GetListCategoryResponse, err error)
	// //Update(ctx context.Context, req *os.UpdateOrder) (resp *os.GetOrder, err error)
	// //Delete(ctx context.Context, req *os.OrderPrimaryKey) (resp *os.Empty, err error)
}
