...
const (
	OrderStatusService_Create_FullMethodName        = "/genproto.OrderStatusService/Create"
	OrderStatusService_GetByID_FullMethodName       = "/genproto.OrderStatusService/GetByID"
	OrderStatusService_PUTCH_FullMethodName         = "/genproto.OrderStatusService/PUTCH"
	OrderStatusService_GetStatusByID_FullMethodName = "/genproto.OrderStatusService/GetStatusByID"
)
...
func (c *orderStatusServiceClient) GetStatusByID(ctx context.Context, in *OrderPrimaryStatusKeyRequest, opts ...grpc.CallOption) (*GetOrderStatusResponse, error) {
	out := new(GetOrderStatusResponse)
	err := c.cc.Invoke(ctx, OrderStatusService_GetStatusByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderStatusService_GetStatusByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderStatusService_GetStatusByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OrderStatusService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "genproto.OrderStatusService",
