...
const (
	CategoryService_Create_FullMethodName  = "/category_service.CategoryService/Create"
	CategoryService_GetByID_FullMethodName = "/category_service.CategoryService/GetByID"
	CategoryService_GetAll_FullMethodName  = "/category_service.CategoryService/GetAll"
	CategoryService_Update_FullMethodName  = "/category_service.CategoryService/Update"
	CategoryService_Delete_FullMethodName  = "/category_service.CategoryService/Delete"
)
...
type CategoryServiceClient interface {
	...
	GetAll(ctx context.Context, in *GetListCategoryRequest, opts ...grpc.CallOption) (*GetListCategoryResponse, error)
...
func (c *categoryServiceClient) GetAll(ctx context.Context, in *GetListCategoryRequest, opts ...grpc.CallOption) (*GetListCategoryResponse, error) {
...
type CategoryServiceServer interface {
	...
	GetAll(context.Context, *GetListCategoryRequest) (*GetListCategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) GetAll(context.Context, *GetListCategoryRequest) (*GetListCategoryResponse, error) {
...
func _CategoryService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetAll(ctx, req.(*GetListCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
